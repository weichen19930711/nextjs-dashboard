...
const ToastDemo = () => {
  ...
  return (
    <Toast.Provider swipeDirection="right" duration={10000} swipeThreshold={50}>
      <button
      ...
      <Toast.Viewport className="fixed right-0 z-[2147483647] m-0 flex w-[390px] max-w-[100vw] list-none flex-col gap-2.5 p-[var(--viewport-padding)] outline-none [--viewport-padding:_25px]" />
    </Toast.Provider>
  );
};
